...
def unproject(camera, points2d, depth):
    ...
    # print(depth[0][points2d[..., 1], points2d[..., 0]].shape)
    # print(origin[None, ...].shape)
    points3d = (
...
#     # print(origin[None, ...].shape)
#     points3d = (
#         directions * depth[0][points2d[..., 1], points2d[..., 0]][:, None] + origin[None, ...]
#     )
